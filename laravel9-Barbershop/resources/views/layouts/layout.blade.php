		...
		<x-nav></x-nav>
			...
			<div class="bg d-flex min-vh-100">
				<div class="align-self-center text-center text-light col-md-8 offset-md-2">
					...
					<button class="btn btn-outline-danger btn-lg fs-5 bg-transparent">
						<a class="text-light p-5 text-decoration-none fw-semibold" href="ContactUs.html">Contact Us</a>
					</button>	
