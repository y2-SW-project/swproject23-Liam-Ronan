...
<html lang="en">
	...
	<body>
		...
		@include('components.bgImageText', ['heading' => 'Edit your Appointment', 'image' => 'pexels-stephen-andrews-9388519-min.jpg'])
				...
				<div class="container d-flex justify-content-center">
					<div class="row bg-black p-5 rounded-5">
						<div class="text-light text-center pt-2">
							...
							<form method="POST" action="{{ route('user.bookings.update', $booking)}}" enctype="multipart/form-data" class="fs-5 heading mt-5">
